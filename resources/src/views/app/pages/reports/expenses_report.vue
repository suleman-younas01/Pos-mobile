    ...
    <div class="main-content">
      ...
      <b-row v-if="!isLoading" class="mb-4">
        <b-col md="4" class="mb-3">
          <b-card class="shadow-sm border-0 h-100 expense-summary-card expense-card-total">
            <div class="d-flex align-items-center">
              <div class="summary-icon rounded-circle mr-3">
                <lucide-icon name="dollar-sign" />
              </div>
              <div>
                <div class="text-muted small text-uppercase">{{ $t('Total_Expenses') }}</div>
                <h4 class="mb-0 font-weight-bold">{{ formatPriceWithSymbol(currentUser && currentUser.currency, totalExpenses, 2) }}</h4>
              </div>
            </div>
          </b-card>
        </b-col>
        <b-col md="4" class="mb-3">
          <b-card class="shadow-sm border-0 h-100 expense-summary-card expense-card-categories">
            <div class="d-flex align-items-center">
              <div class="summary-icon rounded-circle mr-3">
                <lucide-icon name="bar-chart" />
              </div>
              <div>
                <div class="text-muted small text-uppercase">{{ $t('Expense_Category') }}</div>
        ...
        <b-col md="4" class="mb-3">
          <b-card class="shadow-sm border-0 h-100 expense-summary-card expense-card-top">
            <div class="d-flex align-items-center">
              <div class="summary-icon rounded-circle mr-3">
      ...
      <!-- Charts: only render when we have data (avoid empty series) -->
      <b-row v-if="!isLoading" class="mb-4">
        <b-col lg="6" class="mb-3">
          <b-card class="shadow-sm border-0 h-100">
            <h5 class="card-title mb-3">{{ $t('Expenses_by_Category') || 'Expenses by Category' }} ({{ $t('Distribution') || 'Distribution' }})</h5>
        ...
        <b-col lg="6" class="mb-3">
          <b-card class="shadow-sm border-0 h-100">
            <h5 class="card-title mb-3">{{ $t('Expenses_by_Category') || 'Expenses by Category' }} ({{ $t('Total_Expenses') }})</h5>
            <div v-if="chartDataLength" class="chart-wrapper">
