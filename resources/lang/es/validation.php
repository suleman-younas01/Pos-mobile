    ...
    */
    ...
    'custom' => [
        'name' => [
            ...
            'string' => 'El campo nombre debe ser texto.',
            'max' => 'El campo nombre no debe tener más de :max caracteres.',
        ],
        'email' => [
            'required' => 'El campo correo electrónico es obligatorio.',
            'email' => 'El campo correo electrónico debe ser una dirección de correo válida.',
            'max' => 'El campo correo electrónico no debe tener más de :max caracteres.',
            'unique' => 'Este correo electrónico ya está registrado.',
        ],
        'phone' => [
            'required' => 'El campo teléfono es obligatorio.',
            'string' => 'El campo teléfono debe ser texto.',
            'max' => 'El campo teléfono no debe tener más de :max caracteres.',
        ],
        'address' => [
            'required' => 'El campo dirección es obligatorio.',
            'string' => 'El campo dirección debe ser texto.',
            'max' => 'El campo dirección no debe tener más de :max caracteres.',
        ],
        'password' => [
